...
public class TestVoyageurRepository {
	...
	@WeldSetup
	private WeldInitiator weld = WeldInitiator.from(VoyageurRepository.class, VoyageurDAO.class, 
			VoyageRepository.class, VoyageDAO.class, ItineraireRepository.class, ItineraireDAO.class, 
			TrajetRepository.class, TrajetDAO.class, TrainRepository.class, TrainDAO.class, 
