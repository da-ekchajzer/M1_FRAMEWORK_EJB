...
public class ItineraireQueueSupplier implements Supplier<Queue>{
	...
	static {
		...
		jndiBindings.put("queue.ItineraireQueue", "ItineraireQueue");
	...
	public Queue get() {
		try {
			return (Queue) JNDI_CONTEXT.lookup("ItineraireQueue");
		} catch (NamingException e) {
