...
//		Arret arret1 = new Arret(gares.get("Paris - Gare de Lyon"), null, LocalDateTime.now().plus(20, ChronoUnit.SECONDS));
...
//				null);
		...
		Arret arret1_bis = new Arret(gares.get("Perpignan"), null, LocalDateTime.now().plus(20, ChronoUnit.SECONDS));
